...
int main() {
    ...
    if( User *u = cb.validate("Jack", "apple5000"))
        cout << "Found: username: " << u->getUsername() << " and the password is: " << u->getPassword() <<  endl;
    else
    ...
    if( User *u = ca.validate("Jack", "apple4000"))
        cout << "Found: username is: " << u->getUsername() << " and password is: " << u->getPassword() <<  endl;
    else
        cout << "Username or password NOT found" << endl;
...
#if 0
    cout << "Lets now make a couple of objects of LoginServer by main function:" << endl;
    LoginServer x;
    LoginServer y = x;
    x = y;
